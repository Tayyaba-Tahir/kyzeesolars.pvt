...
/>
      ...
      <div className="flex flex-wrap -m-4">
        ...
        <div className="p-4 lg:w-1/3">
          <div className="h-full bg-blue-950 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
        ...
        <div className="p-4 lg:w-1/3">
          <div className="h-full bg-blue-950 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
            <h2 className="tracking-widest text-xs title-font font-mediumtext-white mb-1">
              CATEGORY
            </h2>
            <h1 className="title-font sm:text-2xl text-xl font-medium text-white mb-3">
              SOLAR BATTERIES
            ...
            <a className="text-white hover:text-blue-500 inline-flex items-center">
              Learn More
              <svg
                className="w-4 h-4 ml-2"
                viewBox="0 0 24 24"
